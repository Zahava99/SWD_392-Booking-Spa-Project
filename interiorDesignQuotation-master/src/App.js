...
import ProjectDone from "./component/Login-components/ProjectDone";
...
import AddCustomers from './thi-cong/admin/add-customer';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/updateCustomer/:id' element={< AddCustomers />}></Route>
