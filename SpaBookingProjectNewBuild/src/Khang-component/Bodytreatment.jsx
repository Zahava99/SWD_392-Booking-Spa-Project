...
const Bodytreatment = () => {
  ...
  useEffect(() => {
    fetch('https://67d4f0f4d2c7857431eeec43.mockapi.io/api/Spa/Service')
  ...
  const benefits = [
    ...
    'Cải thiện tuần hoàn máu và lưu thông bạch huyết',
    'Dưỡng ẩm và làm mềm da',
    'Loại bỏ tế bào chết và tái tạo da',
    'Giảm đau nhức cơ và căng cơ',
    'Giúp cơ thể săn chắc và giảm mỡ'
  ];
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Typography color="white">Danh mục</Typography>
        </Breadcrumbs>
      </Box>
